...
plotFigure1= function(rasterNew, criticalNA){
  plot(rasterNew)
  plot(criticalNA, add=TRUE, legend=FALSE,col=alpha("blue"))
}
...
dateToEvaluate= "2019-08"
  ...
  filenameNDVI1 = paste0("data/MonitoringDeseasonalized/Norm_", dat1String ,".tif")
  filenameNDVI2 = paste0("data/MonitoringDeseasonalized/Norm_", dat2String ,".tif")
