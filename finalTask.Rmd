...
v = cube_view(srs="EPSG:3857", extent=col, dx=250, dy=250, dt="P1M", resampling = "average", aggregation = "median")
...
raster_cube(col, v, L8.clear_mask) %>%
  ...
  write_tif("C:/Users/nick1/OneDrive - uni-muenster.de/Master/Semester1/AOSD/finalTask/L8cube2",prefix = "NDVI_")
```
...
raster_cube(col, v, L8.clear_mask) %>%
  select_bands(c("B04", "B05")) %>%
  apply_pixel("(B05-B04)/(B05+B04)") %>%
  write_tif("C:/Users/nick1/OneDrive - uni-muenster.de/Master/Semester1/AOSD/finalTask/L8_croppedL8cube_subregion",prefix = "NDVI_")
```
...
# remotes::install_github("r-spatial/stars")
library(stars)
subdir = "C:/Users/nick1/OneDrive - uni-muenster.de/Master/Semester1/AOSD/finalTask/L8_croppedL8cube_subregion"
f = paste0(subdir, "/", list.files(subdir))
(st = read_stars(f))
plot(merge(st))
```