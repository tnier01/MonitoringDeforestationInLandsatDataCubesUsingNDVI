...
plotRGB(raw, r=3, g=2, b=1, zlim=c(0, 1500), scale=1500, main='Raw with mask', axes=TRUE)
...
s = stack(r1, r2, r3)
levelplot(s, scales=list(draw=FALSE), names.attr=c('NDVI Raw', 'NDVI Filled', 'NDVI Deseasonalized'))
```
