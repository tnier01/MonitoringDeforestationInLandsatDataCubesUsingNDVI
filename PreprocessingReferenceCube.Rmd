...
for(i in times){
  ...
  write_tif(img, "C:/Users/nick1/OneDrive - uni-muenster.de/Master/Semester1/AOSD/finalTask/NDVIFilled",prefix = "NDVIFilled_")
  c = c+1
...
for(i in times){
  print(i)
  fileName=paste0("data/NDVIFilled/NDVIFilled_", i ,".tif")
  r = raster(fileName)
  dimension= dim(r)
  ex = raster::extent(r)
  d=percentile[c]
  ...
  fileName2=paste0("data/NDVIDeseasonalized/NDVIDes_", i ,".tif")
...
img= select_time(L8.cube, "2016-4")
write_tif(img,"./exampleImages",prefix = "Raw_")

img= select_time(L8.NDVI, "2016-4")
write_tif(img,"./exampleImages",prefix = "NDVIraw_")

fileName=paste0("data/NDVIFilled/NDVIFilled_", "2016-4" ,".tif")
r = raster(fileName)
writeRaster(r, "./exmapleImages/NDVIfFilled_2016-04.tif")

fileName=paste0("data/NDVIDeseasonalized/NDVIDes_", "2016-4" ,".tif")
r = raster(fileName)
writeRaster(r, "./exmapleImages/NDVIDes_2016-04.tif")
